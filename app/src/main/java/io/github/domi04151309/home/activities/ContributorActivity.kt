    ...
    class GeneralPreferenceFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            queue.add(JsonArrayRequest(
                    ...
                    for (i in 0 until response.length()) {
                        ...
                        queue.add(ImageRequest(
                            ...
                            { error ->
                                ...
                                addPreference(
                                    currentContributor,
                                    ResourcesCompat.getDrawable(requireContext().resources, R.drawable.ic_about_contributor, requireContext().theme)
                                )
                            }
                        ))
                    }
                ...
                { error ->
                    Toast.makeText(requireContext(), Global.volleyError(requireContext(), error), Toast.LENGTH_LONG).show()
                }
            ))
        }
    }
